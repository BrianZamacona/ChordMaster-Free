...
const List<String> chromaticNotes = TheoryCatalog.chromaticNotes;
...
const Map<String, List<int>> chordFormulas = TheoryCatalog.chordFormulas;

// ── Scale Formulas ─────────────────────────────────────────────────────────

/// Scale formulas expressed as semitone offsets from the root.
const Map<String, List<int>> scaleFormulas = TheoryCatalog.scaleFormulas;

// ── Mode Formulas ──────────────────────────────────────────────────────────

/// Greek mode formulas expressed as semitone offsets from the tonic.
const Map<String, List<int>> modeFormulas = TheoryCatalog.modeFormulas;

// ── Exotic / World Scales ──────────────────────────────────────────────────

/// Exotic scale formulas expressed as semitone offsets from the root.
const Map<String, List<int>> exoticScales = TheoryCatalog.exoticScales;
